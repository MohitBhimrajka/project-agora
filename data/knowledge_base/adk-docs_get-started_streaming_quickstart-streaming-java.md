...
**Source URL:** https://google.github.io/adk-docs/get-started/streaming/quickstart-streaming-java/

---

# Quickstart (Streaming / Java)[¶](#adk-streaming-quickstart-java "Permanent link")
...
## Try Dev UI with text[¶](#try-dev-ui-with-text "Permanent link")
