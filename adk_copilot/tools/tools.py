...
def _get_embedding_for_query(text: str, model_name: str = "text-embedding-004") -> list[float]:
...
def search_resolved_tickets_db(query: str) -> str:
    ...
    # --- THIS IS THE FIX ---
    # Switch from VECTOR_DISTANCE to the universally available COSINE_DISTANCE function.
    # COSINE_DISTANCE is the standard function for this type of search.
    sql_query = f"""
        SELECT
            ticket_id,
            request,
